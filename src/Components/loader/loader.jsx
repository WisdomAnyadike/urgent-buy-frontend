  ...
  return (
    ...
    <svg class="sp" viewBox="0 0 128 128" width="28px" height="28px" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill="none" stroke-linecap="round" stroke-width="16">
        ...
        <g stroke="hsl(223,90%,90%)">
          <path class="sp__worm1" d="M120,64c0,30.928-25.072,56-56,56S8,94.928,8,64" stroke="hsl(0, 0%, 90%)" stroke-dasharray="43.98 307.87" />
        ...
        <g stroke="hsl(0, 0%, 95%" mask="url(#mask1)">
