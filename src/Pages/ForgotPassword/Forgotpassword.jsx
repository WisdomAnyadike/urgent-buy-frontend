...
const handleValidate = (e)=> {
  ...
  return (
              ...
              <div className="row gy-3 gy-md-4 overflow-hidden">
                ...
                <div className="col-12">
                  <div className="d-grid">
                    <button disabled={loading}  onClick={(e)=>handleSubmit(e)} className="btn btn-lg d-flex align-items-center justify-content-center"  style={{backgroundColor:"#000" , color:"white" , fontSize:"15px" , height:'37px'}} type="submit"> { loading ? <Preloader/> : 'Reset Password' }  </button>
                    <ToastContainer/>
                  </div>
                </div>
              </div>
    ...
    <div class="position-relative" >
        <div class="card cardo1 p-5 text-center mt-5 pt-4" style={{width:"fit-content" ,  height:"fit-content"}}>
            ...
            <div class="mt-4"> <button disabled={loading1} onClick={(e)=> handleValidate (e)}  class="btn px-4 validate d-flex align-items-center justify-content-center" style={{backgroundColor:'#000', color:'white' , height:"37px"}}>
            
            {loading1 ? <Preloader/> : 'Validate' } 
